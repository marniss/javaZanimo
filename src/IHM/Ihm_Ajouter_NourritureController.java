...
public class Ihm_Ajouter_NourritureController implements Initializable {
    ...
    private void buttonValiderAction(ActionEvent event) {
        ...
        iror = temp.ajouterNourriture(0, nom.getText(), description.getText(), prix.getText(), qte.getText(), type.getText(), photo.getText(), validite.getValue(), "" + datefavb.getValue(), "" + datelimite.getValue(), IHM_loginController.membre.getIdMembre());
        /**/
        if (iror < 10) {
